...
// Character array pointers
   char  msg[]      = {"Karadio IR+lcd V1.4"}; //
#else
	 char  msg[]      = {"Karadio lcd V1.4"}; //
#endif
   char  msg1[]    = {"(c) KaraWin"}; //
...
#ifdef IRLib2
//	    Serial.print("Protocol:");Serial.print(results.protocolNum);Serial.print("  value:");Serial.println(results.value,HEX);
#else
...
//      Serial.print("  value:");Serial.println(results.value,HEX);
		...
		{
			case 0xFF629D: 
			case 0x10EF48B7:	/*(" FORWARD");*/  irStr[0] = 0;Serial.print("cli.next\r"); break;

			case 0xFF22DD:
			case 0x10EFA857:
			case 0x10EF42BD: /*(" LEFT");*/  irStr[0] = 0;Serial.print("cli.vol-\r");  break;

			case 0xFF02FD:
			case 0x10EF7887:		/*(" -OK-");*/
			{  
//      state?Serial.print("cli.start\r"):Serial.print("cli.stop\r");
        if (strlen(irStr) >0)
        {
...
/*				  if (state)
        ...
        irStr[0] = 0;
			...
			case 0xFFC23D:
			case 0x10EF28D7:
			case 0x10EF827D: /*(" RIGHT");*/ irStr[0] = 0;Serial.print("cli.vol+\r");  break; // volume +
			case 0xFFA857:
			case 0x10EFC837:	/*(" REVERSE");*/ irStr[0] = 0;Serial.print("cli.prev\r"); break;
			case 0xFF6897:
			...
			case 0xFF42BD:
			case 0x10EFE817: /*(" *");*/   irStr[0] = 0;Serial.print("cli.stop\r"); break;
			case 0xFF4AB5:
			case 0x10EF00FF: /*(" 0");*/ nbStation('0');   break;
			case 0xFF52AD:
			case 0x10EFB847: /*(" #");*/   irStr[0] = 0;Serial.print("cli.start\r"); break;
...
void loop(void) {
	serial();
#ifdef IR
    if (loopcount++ == ((x==84)?0x500:0x900)) // 
    {
		 translateIR();
#else
    if (loopcount++ == ((x==84)?0x2000:0x6000)) // 
    {
#endif
	    loopcount = 0;
		if (++scrl%10 == 0) digitalWrite(PIN_LED, HIGH);	
		scroll();	
